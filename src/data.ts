...
export type CommissionSpecial = '' | 'club' | 'consultant'
export type CommissionPayout = { level: CommissionLevel; mode: CommissionMode; value: number | null; special: CommissionSpecial }
...
export const scopeOptions = ['全部体验课', '全部正价课', '平台综合服务费', '俱乐部加盟费', '课程顾问加盟费']
...
export async function fetchRules(): Promise<Rule[]> {
  ...
  return [
    { id: 1, name: '课程标准分润', scope: '全部正价课', selectedCourses: [], attribution: '最后销售转化人', settlement: '课消后 7 天', enabled: true, createdAt: '2026-09-01 09:18:26', updatedAt: '2026-09-08 10:42:15', createdBy: '张敏', updatedBy: '张敏', groups: [
      { participant: '注册邀请', payouts: [{ level: 'levelOne', mode: 'rate', value: 5, special: '' }] },
      { participant: '销售转化', payouts: [{ level: 'levelTwo', mode: 'rate', value: 20, special: '' }] }
    ] },
    { id: 2, name: '合伙人招募分润', scope: '俱乐部加盟费', selectedCourses: [], attribution: '邀请注册绑定人', settlement: '人工结算', enabled: true, createdAt: '2026-08-28 14:06:51', updatedAt: '2026-09-07 16:23:08', createdBy: '李想', updatedBy: '王芳', groups: [
      { participant: '注册邀请', payouts: [{ level: 'levelOne', mode: 'rate', value: 8, special: '' }, { level: 'top', mode: 'rate', value: 2, special: 'club' }] },
      { participant: '招聘老师', payouts: [{ level: 'levelTwo', mode: 'rate', value: 15, special: '' }] }
    ] },
    { id: 3, name: '老客复购保护', scope: '全部体验课', selectedCourses: [], attribution: '最后销售转化人', settlement: '交易完成后 7 天', enabled: false, createdAt: '2026-09-03 11:32:04', updatedAt: '2026-09-07 09:15:42', createdBy: '张敏', updatedBy: '赵磊', groups: [
      { participant: '销售转化', payouts: [{ level: 'levelOne', mode: 'amount', value: 20, special: 'consultant' }] }
    ] }
  ]
}
export const emptyGroup = (): CommissionGroup => ({ participant: '', payouts: [{ level: 'levelOne', mode: 'rate', value: null, special: '' }] })
